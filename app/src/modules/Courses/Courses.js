...
export { getCourseDetails, getUserCourses, getMostPopularCourses, createCourse, updateCourse, deleteCourse, courseRegEx, courseTitleTooltipLines, registerForCourse, checkIfInCourse }